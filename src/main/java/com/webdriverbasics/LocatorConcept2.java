...
public class LocatorConcept2 {
	...
	public static void main(String[] args) {
		 ...
		 * "veera123"); driver.findElement(By.xpath(
		 * "//*[@id=\"content\\\"]/div/div[2]/div/form/input")).click(); By emailID =
		 * By.xpath("//*[@id=\"input-email\"]"); By password =
		 ...
		 * By forgetPassword = By.partialLinkText("Forgot");
		 * doClick(forgetPassword);
		 */
		
		//8.tagName : html tag
      // String header = driver.findElement(By.tagName("h2")).getText();
		By getHeader = By.tagName("h2");
		String headerText = doElementGetText(getHeader);
